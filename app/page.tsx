...
export default function Home() {
  ...
  return <main className={`page main-home ${dark ? "theme-dark" : "theme-light"}`}><div className="ambient ambient-one"/><div className="ambient ambient-two"/>
    <nav className="nav"><a className="logo" href="#home"><span className="logo-mark">G</span>GOKUL<span className="logo-dot">.AI</span></a><div className="navlinks"><a href="#about">About</a><a href="#skills">Skills</a><a href="#projects">Projects</a><a href="#assistant">AI</a><a href="#contact">Contact</a><a href="/days">Daily Builds</a></div><div className="main-nav-actions"><button className="theme-toggle-main" onClick={() => setDark(v => !v)} aria-label={dark ? "Switch to light mode" : "Switch to dark mode"} aria-pressed={dark}>{dark ? "☀️ Light" : "🌙 Dark"}</button><a className="nav-cta" href="#assistant"><span className="pulse"/> Ask AI</a></div></nav>
