...
@media (max-width: 560px) {
  .card { grid-template-columns: 48px 1fr 24px; padding: 18px; gap: 12px; }
  .number { font-size: 24px; }
  .card h2 { font-size: 24px; }
  .note { flex-direction: column; gap: 5px; }
  h1 { letter-spacing: -3px; }
}
`;

export function generateMetadata() {
  return { title: "Daily Builds · Gokul" };
}

export const runtime = "edge";

// Global page styles are injected through the root layout in production.
// Keep this page free of styled-jsx so it remains a Server Component.
