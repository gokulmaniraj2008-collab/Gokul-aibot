...
export default function DaysPage() {
  return (
    <main className="page daily-builds theme-light" style={{ minHeight: "100vh" }}>
      ...
      <footer className="footer"><span>© 2026 GOKUL.AI · DAILY BUILDS</span><span>DAY 15 BUILDING</span><a href="/">BACK TO PORTFOLIO ↑</a></footer>
    </main>
  );
}
